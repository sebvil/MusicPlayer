...
data class ArtistDetailsUiComponent(
    val arguments: ArtistDetailsArguments,
    val navController: NavController,
) : BaseUiComponent<ArtistDetailsState, ArtistDetailsUserAction, ArtistDetailsStateHolder>() {

    override fun createStateHolder(services: Services): ArtistDetailsStateHolder {
